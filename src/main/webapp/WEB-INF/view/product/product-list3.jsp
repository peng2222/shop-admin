...
<head>
    ...
    <script>
        ...
        function initAddSpuAttributeDiv(spuAttributeArr) {
            ...
            $("#addSpuAttributeDiv").html(addSpuAttributeDivHTML);
        ...
        function initAddSkuAttributeDiv(skuAttributeArr){
            ...
            for(var i = 0 ; i < skuAttributeArr.length ; i ++){
                ...
                if(skuAttributeArr[i].inputType == 1){
                    ...
                    var valueIdArr = skuAttributeArr[i].valueIdList.split(",");
                    for(var j = 0; j < valueArr.length ; j++){
                        addSkuAttributeDivHTML += "<input type='checkbox' name='abc' valueId='" + valueIdArr[j] + "' value='" + valueArr[j]+ "' onclick='initSkuTable()'/>" + valueArr[j];
                    }
        ...
        function abc(obj){
            ...
            $.ajax({
                ...
                success:function(result){
                    ...
                    if(result.code == 200){
                        var classifySelectHTML = "<div class='col-sm-4'><select onchange='abc(this)' style='width:100px' class='form-control'><option value='-1'>请选择</option>";
