...
<head>
    ...
    <script>
        ...
        var arr1 = [["红色","绿色"],["16G","32G","64G"]];
        var arr2 = DescartesUtils.descartes(arr1);
        console.log(arr2);
...
<body>
    ...
    <button onclick="showUpdateProductDialog(3)" type="button" class="btn btn-primary">
