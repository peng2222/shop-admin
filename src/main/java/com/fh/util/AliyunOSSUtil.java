...
public class AliyunOSSUtil {
    ...
    private final static String ACCESS_KEY_ID = "LTAI4Fq5vxLCqZPTdy4JSd4Z";
    private final static String ACCESS_KEY_SECRET = "eY2oYFWMcNG73fYXR5uuf0FV9NShVx";
    private final static String BUCKET_NAME = "renchaopeng";
    private final static String BUCKET_URL = "https://renchaopeng.oss-cn-beijing.aliyuncs.com";
